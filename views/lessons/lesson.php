            ...
            <div class="posLeft">
                <div class="videoField">
                    ...
                    <div class="backgroundField">
                        <div style="cursor:pointer" data-action="<?=$action_hybrid ? '1' : '0'?>" data-video="<?=$change_video['id']?>" class="<?=is_null($check_video_watched) ? 'backgroundVideo' : 'd-none' ?>" ><?=$GLOBALS['text']['clickToWatch']?></div>
