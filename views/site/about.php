...
<script>
    function blog() {
        return  '<div class="shapeRight">'+
            ...
            '<span class="rightShapeTextBig"><?=$GLOBALS['text']['aboutLong']?></span>'+
            '<span class="rightShapeTextSmall"><?=$GLOBALS['text']['aboutCollaboration']?></span>'+
            '</div>'+
            '</div>'+
            '</div>'+
            ...
            '<span class="rightShapeBottomTextBig"><?=$GLOBALS['text']['aboutIndividual']?></span>'+
            '<span class="rightShapeBottomTextSmall"><?=$GLOBALS['text']['aboutEach']?></span>'+
            '</div>'+
            '</div>'+
            '</div>';
    ...
    function blog1() {
        return  `<div class="mainTextLeftContent">`+
