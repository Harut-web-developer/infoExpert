...
function display_list($nested_categories, $type = 'sortable', $level = 0)
{
    if($type == 'sortable'){
        ...
        foreach($nested_categories as $nested){
            ...
            $list .= '<b>'.$nested['name_am'].' <a style="float:right;" href="/admin/answer?id='.$nested['id'].'">Պատասխաններ</a>';
            $list .= '</b>';
            $list .= '</div>';
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addnew">Ավելացնել հարց</h5>
            ...
            <div class="modal-body">
                <form action="" method="post" enctype="multipart/form-data" id="Categories_">
                    ...
                    <input type="hidden" name="AcQuestionQuests[question_id]" value="<?= $_GET['id']; ?>" />
